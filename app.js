(function () {
  ...
  // Configuration Supabase (projet "Topscineastes", table dédiée top1000)
  ...
  var SUPABASE_DATA_URL =
    SUPABASE_URL + "/rest/v1/top1000?select=data&id=eq.1";
  ...
  function init() {
    ...
    fetch(SUPABASE_DATA_URL, {
      ...
      .then(function (rows) {
        var json = rows && rows[0] ? rows[0].data : null;
