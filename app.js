(function () {
  ...
  function initMosaicBanner() {
    ...
    // Charger les 6 premières photos disponibles
    var loaded  = [];
    var cursor  = 0;
    var TARGET  = 6;
    ...
    function loadNext() {
      ...
      img.onload = function () {
        ...
        // Mettre à jour la mémoire de session (max 30 entrées)
      ...
      img.onerror = function () {
        // Photo manquante : retirer du banner et essayer la suivante
      ...
      // Continuer jusqu'à TARGET images
      if (loaded.length < TARGET) loadNext();
    }

    for (var t = 0; t < TARGET; t++) loadNext();
  }
